  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <p className="text-sm text-gray-600 mb-8">Last updated: April 22, 2026</p>
        ...
        <p className="mb-4 text-gray-700">For the purposes of these Terms and Conditions:</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3 text-gray-700">
          ...
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) 
            refers to ase technologies, LIG A85, North Extension, Beside lane of SBI, Seethammadhara, visakhapatnam-530013.
          </li>
          <li>
          ...
          <li>
            <strong>Terms and Conditions</strong> (also referred to as "Terms") means these Terms and Conditions, including any 
            documents expressly incorporated by reference, which govern Your access to and use of the Service and form the entire 
            agreement between You and the Company regarding the Service. These Terms and Conditions have been created with the help 
            of the <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank" rel="noopener noreferrer" 
            className="text-blue-600 hover:underline">TermsFeed Terms and Conditions Generator</a>.
          </li>
          <li>
            <strong>Third-Party Social Media Service</strong> means any services or content (including data, information, products 
            or services) provided by a third party that is displayed, included, made available, or linked to through the Service.
          </li>
          <li>
            <strong>Website</strong> refers to smarteduconnects, accessible from{" "}
            <a href="https://smarteduconnects.com" target="_blank" rel="noopener noreferrer" 
            className="text-blue-600 hover:underline">smarteduconnects.com</a>
          </li>
          <li>
        ...
        <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Links from a Third-Party Social Media Service</h3>
        <p className="mb-4 text-gray-700">
        ...
        <p className="mb-4 text-gray-700">
          ...
          provision of these Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid 
        ...
        <p className="mb-4 text-gray-700">
          ...
          or otherwise in connection with any provision of these Terms), even if the Company or any supplier has been advised of the 
        ...
        <p className="mb-4 text-gray-700">
          ...
          terms. If You do not agree to the new terms, in whole or in part, please stop using the Service.
        </p>
        ...
        <ul className="list-disc pl-6 mb-8 text-gray-700">
          <li>By email: info@asetechnologies.in</li>
        </ul>
      </div>
    </div>
  );
