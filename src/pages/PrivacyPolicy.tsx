    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3 text-gray-700">
          ...
          <li>
            <strong>Personal Data</strong> (or "Personal Information") is any information that relates to an identified or 
            identifiable individual.
            <p className="mt-2">We use "Personal Data" and "Personal Information" interchangeably unless a law uses a specific term.</p>
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to smarteduconnect, accessible from{" "}
            <a 
              href="https://smarteduconnect.in" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-blue-600 hover:underline"
            >
        ...
        <p className="mb-4 text-gray-700">We use both Session and Persistent Cookies for the purposes set out below:</p>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
          ...
          <li>
            ...
            which We offer that are similar to those that you have already purchased or inquired about unless You have opted not to 
          ...
          <li>
            <strong>For business transfers:</strong> We may use Your Personal Data to evaluate or conduct a merger, divestiture, 
        ...
        <p className="mb-4 text-gray-700">We may share Your Personal Data in the following situations:</p>
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li>
            <strong>With Service Providers:</strong> We may share Your Personal Data with Service Providers to monitor and analyze 
            the use of our Service, to contact You.
          </li>
          <li>
            <strong>For business transfers:</strong> We may share or transfer Your Personal Data in connection with, or during 
            negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to 
            another company.
          </li>
          <li>
            <strong>With Affiliates:</strong> We may share Your Personal Data with Our affiliates, in which case we will require 
          ...
          <li>
            <strong>With business partners:</strong> We may share Your Personal Data with Our business partners to offer You certain 
            products, services or promotions.
          </li>
          <li>
            <strong>With other users:</strong> If Our Service offers public areas, when You share Personal Data or otherwise interact 
            in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-3 text-gray-700">
          <li>
            ...
            <ul className="list-circle pl-6 mt-2">
              <li>
                User Accounts: retained for the duration of your account relationship plus up to 24 months after account closure to 
          ...
          <li>
            ...
            <ul className="list-circle pl-6 mt-2 space-y-1">
              <li>
                Support tickets and correspondence: up to 24 months from the date of ticket closure to resolve follow-up inquiries, 
        ...
        <p className="mb-4 text-gray-700">We may retain Personal Data beyond the periods stated above for different reasons:</p>
        ...
        <ul className="list-disc pl-6 mb-6 text-gray-700">
          ...
          <li>
            Backup retention: Residual copies may remain in encrypted backups for a limited period consistent with our backup retention 
            schedule and are not restored except where necessary for security, disaster recovery, or legal compliance.
          </li>
          <li>
            Anonymization: In some cases, We convert Personal Data into anonymous statistical data that cannot be linked back to You. 
            This anonymized data may be retained indefinitely for research and analytics.
          </li>
        </ul>
        ...
        <p className="mb-4 text-gray-700">
          The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process 
          and transfer information about Your activity on Our Service in accordance with their Privacy Policies.
        </p>

        <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Usage, Performance and Miscellaneous</h3>
        <p className="mb-4 text-gray-700">We may use third-party Service Providers to maintain and improve our Service.</p>
        <ul className="list-disc pl-6 mb-6 text-gray-700">
          <li>
            <strong>Google Places</strong>
            <p className="mt-2">Google Places is a service that returns information about places using HTTP requests. It is operated by Google</p>
            <p className="mt-2">Google Places service may collect information from You and from Your Device for security purposes.</p>
            <p className="mt-2">
